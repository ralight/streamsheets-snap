...
const { CREATE_GRAPH_MESSAGE_TYPE, CREATE_STREAMSHEET_MESSAGE_TYPE, DELETE_GRAPH_MESSAGE_TYPE, DELETE_STREAMSHEET_MESSAGE_TYPE, GET_GRAPH_MESSAGE_TYPE, LOAD_GRAPH_MESSAGE_TYPE, LOAD_SUBSCRIBE_GRAPH_MESSAGE_TYPE, SUBSCRIBE_GRAPH_MESSAGE_TYPE, UNSUBSCRIBE_GRAPH_MESSAGE_TYPE } = require('@cedalo/protocols').GraphServerMessagingProtocol.MESSAGE_TYPES;
const { LOAD_SHEET_CELLS } = require('@cedalo/protocols').MachineServerMessagingProtocol.MESSAGE_TYPES;
