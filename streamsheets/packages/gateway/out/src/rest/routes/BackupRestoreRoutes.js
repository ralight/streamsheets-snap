...
const isValid13RestoreJson = (json) => json && json.graphs && json.machines && json.auth_user && json.datasources && !json.streams;
        ...
        switch (request.method) {
            case 'GET':
                try {
                    ...
                    const result = entries.reduce((obj, [collection, data]) => ({
                        ...obj,
                        [collection]: data
                    }), {});
        ...
        switch (request.method) {
            case 'POST':
                try {
                    ...
                    const fixedRestoreJson = fixedAuthData.reduce((acc, [collection, docs]) => ({
                        ...acc,
                        [collection]: docs
                    }), restoreJson);
...
//# sourceMappingURL=BackupRestoreRoutes.js.map